...
if os.path.exists(BUNDLE_FILE):
    ...
    with tab1:
        ...
        if 'confidence' in df.columns:
            ...
            confidence_bins = pd.cut(df['confidence'], bins=[0, 50, 70, 80, 90, 100], 
        ...
        top_bundles = df.nlargest(20, 'confidence')[['part1', 'part2', 'customers', 'confidence', 'revenue_estimate']]
